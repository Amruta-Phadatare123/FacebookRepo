...
public static String path="C:\\Users\\phada\\OneDrive\\Documents\\MavenExel.xlsx";
	...
	public static void captureScreenShot(WebDriver driver,String fileName) throws IOException 
	{
			...
			FileHandler.copy(src,new File("C:\\Users\\phada\\Downloads\\Desktop\\sqlquerry\\sqlpatternsearch.sql.png"+fileName+ ""+ date));				
	}
